...
for (const required of ["build-release-v2-4.mjs", "apply-notion-snapshot.mjs", "build-study-index.mjs", "build-public.mjs", "fixed-build-time.mjs"]) if (!buildCommand.includes(required)) fail(`Etapa obrigatória ausente no build: ${required}`);
