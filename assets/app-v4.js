const CATALOG_URL = "./data/release/catalogo.json?release=3048-2971-69-r2";
const RELEASE_META_URL = "./data/release/release-meta.json?release=3048-2971-69-r2";
const EXAM_URL = "./data/concurso.json";
const STUDY_INDEX_URL = "./data/release/study-index.json?release=3048-2971-69-r2";
