const CATALOG_URL = "./data/release/catalogo.json?release=3048-3046-71-r3";
const RELEASE_META_URL = "./data/release/release-meta.json?release=3048-3046-71-r3";
const EXAM_URL = "./data/concurso.json";
const STUDY_INDEX_URL = "./data/release/study-index.json?release=3048-3046-71-r3";
