const CACHE_VERSION = "sedes-questoes-v2-13-0-r2";
const INDEX_URL = new URL("./index.html", self.location.href).toString();
const SHELL = [
  "./", "./index.html", "./manifest.webmanifest", "./assets/styles.css?v=2", "./assets/dashboard.css?v=1", "./assets/quality-v2-3.css?v=1", "./assets/true-false.css?v=2", "./assets/question-images-v2-5.css?v=1", "./assets/study-navigation-v2-6.css?v=1", "./assets/intelligence-v2-9.css?v=1", "./assets/reports-v2-10.css?v=2", "./assets/material-downloads-v1.css?v=1", "./assets/platform-v2-13.css?v=1", "./assets/discursive-display-v2-13.css?v=1", "./assets/progress-migration-v2-3.js?v=1", "./assets/question-images-v2-5.js?v=1", "./assets/app-v4.js?v=10", "./assets/discursive-display-v2-13.js?v=1", "./assets/learning-v2-9.js?v=1", "./assets/pwa-v2-9.js?v=1", "./assets/reports-v2-10.js?v=2", "./assets/material-downloads-v1.js?v=1", "./assets/shared-v2-13.js?v=1", "./assets/release-v2-13.js?v=1", "./assets/vault-v2-13.js?v=1", "./assets/report-v2-13.js?v=1", "./assets/official-exam-v2-13.js?v=1", "./assets/adaptive-review-v2-13.js?v=1", "./data/concurso.json", "./data/release/catalogo.json?release=3048-2971-69-r2", "./data/release/study-index.json?release=3048-2971-69-r2", "./data/release/build-info.json?release=3048-2971-69-r2", "./data/release/release-meta.json?release=3048-2971-69-r2"
];
...
self.addEventListener("fetch", event => {
  ...
  const isMutableData = /\/data\/(release\/(catalogo|study-index|build-info|release-meta)|concurso)\.json$/.test(url.pathname);
