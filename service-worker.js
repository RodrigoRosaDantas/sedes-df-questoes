...
self.addEventListener("fetch", event => {
  ...
  if (isMutableData || isVersionedApplicationAsset || isMaterial) { event.respondWith(networkFirst(event.request, {noStore: true})); return; }
