...
console.log(`✓ Plataforma 2.13 validada: ${questions} questões, ${materials} materiais, metadados em Configurações, cofre local, reporte, prova real e revisão adaptativa.`);
