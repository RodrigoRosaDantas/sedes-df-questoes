...
const commandCenter = read("assets/work-command-center-v1.js");
const report = read("assets/report-v2-13.js");
const css = read("assets/work-convergence-v1.css");
const commandCss = read("assets/work-command-center-v1.css");
...
requireMarkers(index, ["work-convergence-v1.css?v=1", "work-command-center-v1.css?v=1", "work-convergence-v1.js?v=1", "work-command-center-v1.js?v=1", "report-v2-13.js?v=2"], "Shell Work");
requireMarkers(worker, ["work-convergence-v1.css?v=1", "work-command-center-v1.css?v=1", "work-convergence-v1.js?v=1", "work-command-center-v1.js?v=1", "report-v2-13.js?v=2", "content-model-v1.json"], "PWA Work");
...
requireMarkers(commandCenter, [
  "data-work-command-center",
  "data-work-now",
  "data-work-bank",
  "data-work-review",
  "data-work-errors",
  ...
  "data-work-search",
  "data-work-cloud-state",
], "Central de comando Work");
requireMarkers(css, ["work-convergence-settings", "work-direct-pdf-actions", "work-account-dialog"], "CSS Work");
requireMarkers(commandCss, [
  ".work-command-center",
  ".work-command-grid",
  ".work-command-action:first-child",
...
console.log("✓ Convergência Work validada: conta-perfil, preferências sincronizáveis, central de comando responsiva, relatos internos, PDF direto e modelo normalizado.");
