const CACHE_VERSION = "sedes-questoes-v2-13-0-r6-cloud";
const INDEX_URL = new URL("./index.html", self.location.href).toString();
const SHELL = [
  "./", "./index.html", "./manifest.webmanifest", "./assets/styles.css?v=2", "./assets/dashboard.css?v=1", "./assets/quality-v2-3.css?v=1", "./assets/true-false.css?v=2", "./assets/question-images-v2-5.css?v=1", "./assets/study-navigation-v2-6.css?v=1", "./assets/intelligence-v2-9.css?v=1", "./assets/reports-v2-10.css?v=2", "./assets/material-downloads-v1.css?v=1", "./assets/platform-v2-13.css?v=1", "./assets/discursive-display-v2-13.css?v=1", "./assets/ux-v2-14.css?v=1", "./assets/navigation-v2-15.css?v=1", "./assets/navigation-v2-15-polish.css?v=1", "./assets/home-study-today-v2-16.css?v=1", "./assets/home-study-subjects-v2-17.css?v=7", "./assets/resolver-context-v2-19.css?v=1", "./assets/resolver-stability-v2-23.css?v=1", "./assets/cloud-progress-v1.css?v=1", "./assets/progress-migration-v2-3.js?v=1", "./assets/question-images-v2-5.js?v=1", "./assets/app-v4.js?v=13", "./assets/discursive-display-v2-13.js?v=1", "./assets/learning-v2-9.js?v=1", "./assets/pwa-v2-9.js?v=1", "./assets/reports-v2-10.js?v=2", "./assets/material-downloads-v1.js?v=1", "./assets/shared-v2-13.js?v=1", "./assets/release-v2-13.js?v=1", "./assets/vault-v2-13.js?v=1", "./assets/report-v2-13.js?v=1", "./assets/official-exam-v2-13.js?v=1", "./assets/adaptive-review-v2-13.js?v=1", "./assets/ux-v2-14.js?v=1", "./assets/ux-v2-14-guardrails.js?v=1", "./assets/navigation-v2-15.js?v=1", "./assets/navigation-v2-15-polish.js?v=1", "./assets/home-study-edital-v2-18.js?v=1", "./assets/home-study-today-v2-16.js?v=5", "./assets/home-study-subjects-v2-17-stable.js?v=7", "./assets/resolver-context-v2-19.js?v=2", "./assets/cloud-progress-v1.js?v=1", "./assets/work-command-center-v1.js?v=1", "./data/concurso.json", "./data/release/question-format-index.json", "./data/release/question-search-index.json", "./data/release/catalogo.json", "./data/release/study-index.json", "./data/release/build-info.json", "./data/release/release-meta.json"
];
...
self.addEventListener("fetch", event => {
  ...
  const isMutableData = /\/data\/(release\/(catalogo|study-index|question-search-index|question-format-index|build-info|release-meta)|concurso)\.json$/.test(url.pathname);
