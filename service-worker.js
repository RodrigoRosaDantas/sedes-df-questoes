...
self.addEventListener("fetch", event => {
  ...
  const isMutableData = /\/data\/(release\/(catalogo|study-index|question-search-index|question-format-index|content-model-v1|build-info|release-meta)|concurso)\.json$/.test(url.pathname);
