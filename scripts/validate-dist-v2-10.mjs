...
if (!buildInfo.source_files_sha256?.index_html || !buildInfo.source_files_sha256?.app_js || !buildInfo.source_files_sha256?.service_worker_js || !buildInfo.source_files_sha256?.pwa_js) {
...
console.log(`✓ Dist ${packageData.version} validado: cache ${expectedCacheVersion}, ${questionCount} questões, ${materialCount} materiais, snapshot do Notion e proveniência reproduzível.`);
