...
self.addEventListener("fetch", event => {
  ...
  const isMutableData = /\/data\/(release\/(catalogo|study-index|question-search-index|build-info|release-meta)|concurso)\.json$/.test(url.pathname);
