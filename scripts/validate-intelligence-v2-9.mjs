...
for (const feature of ["manifest.webmanifest", "intelligence-v2-9.css", "app-v4.js?v=5", "learning-v2-9.js", "pwa-v2-9.js"]) if (!index.includes(feature)) fail(`Integração ausente no HTML: ${feature}`);
...
console.log(`✓ Plataforma inteligente validada: ${questionCount} questões, ${materialCount} materiais, revisão espaçada, painel Hoje, tópicos, Anki, PWA, dist e teste de navegador.`);
