...
const hasLevelFilter = app.includes("study-level") || app.includes("builder-level");
const hasOpenAccess = app.includes("Todo o acervo é acessível") || app.includes("Todos os perfis podem acessar todo o acervo") || app.includes("Provas sempre visíveis");
if (!hasLevelFilter || !hasOpenAccess) fail("Filtro por nível ou acesso livre ausente.");
